...
<div class="flex items-center justify-between rounded-md border-2 border-gray-one px-4 py-4">
  <div class="flex w-full items-center justify-start">
    ...
    <input 
      ...
      class="h-4 w-4 rounded border border-gray-three bg-cream text-green-four focus:border-green-five focus:outline-green-five  max-w-lg"
    >

    <label for={`${todo.id}-text`} class="hidden">Edit todo</label>
     <input 
      type="text"
      id={`${todo.id}-text`}
      checked={todo.complete}
      ...
      class="ml-5 flex-1 text-ellipsis rounded-none border-x-0 border-t-0 border-b border-b-gray-two bg-cream-four px-0 pb-1 text-base font-normal text-gray-three placeholder:text-gray-two focus:border-gray-three focus:outline-none focus:ring-0"
    >
